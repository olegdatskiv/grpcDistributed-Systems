...
from client_grpc import ReplicatedLog_pb2 as client__grpc_dot_ReplicatedLog__pb2
...
class PostRequestServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PostRequest = channel.unary_unary(
                ...
                request_serializer=client__grpc_dot_ReplicatedLog__pb2.POST.SerializeToString,
                response_deserializer=client__grpc_dot_ReplicatedLog__pb2.POSTResponse.FromString,
                )
...
def add_PostRequestServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PostRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=client__grpc_dot_ReplicatedLog__pb2.POST.FromString,
                    response_serializer=client__grpc_dot_ReplicatedLog__pb2.POSTResponse.SerializeToString,
            ),
    }
...
class PostRequestService(object):
    ...
    def PostRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/PostRequestService/PostRequest',
            client__grpc_dot_ReplicatedLog__pb2.POST.SerializeToString,
            client__grpc_dot_ReplicatedLog__pb2.POSTResponse.FromString,
...
class GetRequestServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRequest = channel.unary_unary(
                ...
                request_serializer=client__grpc_dot_ReplicatedLog__pb2.GET.SerializeToString,
                response_deserializer=client__grpc_dot_ReplicatedLog__pb2.GETResponse.FromString,
                )
...
def add_GetRequestServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetRequest': grpc.unary_unary_rpc_method_handler(
                    servicer.GetRequest,
                    request_deserializer=client__grpc_dot_ReplicatedLog__pb2.GET.FromString,
                    response_serializer=client__grpc_dot_ReplicatedLog__pb2.GETResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class GetRequestService(object):
    ...
    def GetRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/GetRequestService/GetRequest',
            client__grpc_dot_ReplicatedLog__pb2.GET.SerializeToString,
            client__grpc_dot_ReplicatedLog__pb2.GETResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class AskHeartBeatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HeartBeatRequest = channel.unary_unary(
                ...
                request_serializer=client__grpc_dot_ReplicatedLog__pb2.AskHeartBeat.SerializeToString,
                response_deserializer=client__grpc_dot_ReplicatedLog__pb2.HeartBeat.FromString,
                )
...
def add_AskHeartBeatServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'HeartBeatRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=client__grpc_dot_ReplicatedLog__pb2.AskHeartBeat.FromString,
                    response_serializer=client__grpc_dot_ReplicatedLog__pb2.HeartBeat.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class AskHeartBeatService(object):
    ...
    def HeartBeatRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AskHeartBeatService/HeartBeatRequest',
            client__grpc_dot_ReplicatedLog__pb2.AskHeartBeat.SerializeToString,
            client__grpc_dot_ReplicatedLog__pb2.HeartBeat.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class AskHeartBeatsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HeartBeatRequest = channel.unary_unary(
                ...
                request_serializer=client__grpc_dot_ReplicatedLog__pb2.AskHeartBeat.SerializeToString,
                response_deserializer=client__grpc_dot_ReplicatedLog__pb2.HeartBeats.FromString,
                )
...
def add_AskHeartBeatsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'HeartBeatRequest': grpc.unary_unary_rpc_method_handler(
                    servicer.HeartBeatRequest,
                    request_deserializer=client__grpc_dot_ReplicatedLog__pb2.AskHeartBeat.FromString,
                    response_serializer=client__grpc_dot_ReplicatedLog__pb2.HeartBeats.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class AskHeartBeatsService(object):
    ...
    def HeartBeatRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/AskHeartBeatsService/HeartBeatRequest',
            client__grpc_dot_ReplicatedLog__pb2.AskHeartBeat.SerializeToString,
            client__grpc_dot_ReplicatedLog__pb2.HeartBeats.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
